...
urlpatterns = [
    ...
    url(r'^search/$', SearchView.as_view(), name='search'),  #/home/
    url(r'^tags/(?P<hashtag>.*)/$',HashTagView.as_view(), name='hashtag'),
    url(r'^tweet/', include(('tweets.urls','tweets'), namespace="tweet")),
    url(r'^api/tags/(?P<hashtag>.*)/$', TagTweetAPIView.as_view(), name='tag-tweet-api'),  #/home/
    url(r'^api/search/$', SearchTweetAPIView.as_view(), name='search-api'),  #/home/
    url(r'^api/tweet/', include(('tweets.api.urls','tweets'), namespace="tweet-api")),
    url(r'^api/', include(('accounts.api.urls','profile'), namespace="profile-api")),
    url(r'^register/$', UserRegisterView.as_view(), name='register'),  #/home/
